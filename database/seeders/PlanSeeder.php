...
class PlanSeeder extends Seeder
{
	public function run(): void
	{
		Plan::updateOrCreate(
			...
			array(
				"name" => "Free",
				"description" => "All features included. Scan your site, add pages, track competitors, get AI recommendations.",
				"price_monthly" => 0,
				"price_annual" => 0,
				"max_users" => 1,
				"max_projects" => 1,
		...
		Plan::updateOrCreate(
			...
			array(
				"name" => "Pro",
				"description" => "More volume for professionals. 100 scans, 5 projects, and a 5-person team.",
				"price_monthly" => 49.00,
				"price_annual" => 468.00,
				"max_users" => 5,
				"max_projects" => 5,
