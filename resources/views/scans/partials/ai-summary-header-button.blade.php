...
@if($scan && $scan->isComplete())
	...
	@if($hasApiKey)
		<button
			...
			class="inline-flex cursor-pointer items-center gap-1.5 rounded-md bg-ai px-3 py-2 text-sm font-medium text-white transition hover:bg-ai-hover"
		...
		>
			...
			{{ $hasSummary ? "View AI Summary" : "AI Summary" }}
		</button>
	@else
